  ...
  return (
    <div className="bg-dark text-warning mx-0 my-0" id="card-page">
      ...
      <div className="col">
       ...
       <div className="row d-flex justify-content-center">
        <div className="col">
          <PortfolioCard projectImg={profileImg} Title="Note-Taker" Description={description}Githuburl="https://github.com/jreeve65/Notetaker" Appurl="https://note-taker-1b3e.onrender.com"></PortfolioCard>
        </div>
        <div className="col">
          <PortfolioCard projectImg={profileImg}></PortfolioCard>
        </div>
        <div className="col">
          <PortfolioCard projectImg={profileImg}></PortfolioCard>
        </div>
